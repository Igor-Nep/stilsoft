...
pu_id = DbMurom('192.168.202.238').get_module_id('sdp881')
...
#hbty
#speed = [0.5,0.5,0.6,0.5,,0.1,,0.7, 0.5,0.5,0.6,0.5,0.2,0.1, 0.5,0.5,0.5,0.6,0.5,0.1,0.7,0.6, 0.4,0.4,0.3,0.1,0.2,0.1]
#pan = [-20 if i % 2 == 0 else 20 for i in range(len(speed))]
#pause = [2,2,2,2,2,4,2,2,2,2,2,4,2,2,2,2,2,2,2,4,2,2,2,2,2,4]
